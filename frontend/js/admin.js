...
document.getElementById('formularioContacto').addEventListener('submit', function(event) {
    ...
    fetch(`https://andresbasepy.pythonanywhere.com/mensajes/${id}`, {
      method: 'PUT',
      body: formData
    })
    .then(response => response.json())
    .then(data => {
      ...
      document.getElementById('mensajecontestado').style.display = 'block';
      ...
      document.getElementById('mensajecontestado').style.display = 'none';
      }, 5000);
